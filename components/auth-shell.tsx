  ...
  return (
    <>
      <nav className='mb-6 flex flex-wrap items-center gap-4 text-sm'>
        ...
        <Link href='/rates'>Rates</Link><Link href='/ipc-periods'>IPC Periods</Link><Link href='/ipc-preview'>IPC Preview</Link><Link href='/imports'>Imports</Link><Link href='/reports'>Reports</Link><Link href='/supplier-portal'>Supplier Portal</Link><Link href='/settings/members'>Members</Link>
